...
public class ScreenRecorder extends Thread {
    ...
    private SurfaceNeeded mSurfaceListener;
    ...
    public ScreenRecorder(int width, int height, int bitrate, int dpi, int audioSampleRate, int audioBitrate, MediaProjection mp, String dstPath, ScreenRecordListener listener, SurfaceNeeded surfaceNeeded) {
        super(TAG);
        mWidth = width;
        mHeight = height;
        mBitRate = bitrate;
        ...
        mDstPath = dstPath;
        mListener = listener;
        mSurfaceListener = surfaceNeeded;
        mStartTime = 0;
    }
    ...
    public void run() {
        try {
            ...
            if (mSurfaceListener != null) {
                mSurfaceListener.onSurfaceNeeded(mSurface);
            }
    ...
    public interface SurfaceNeeded{
        void onSurfaceNeeded(Surface surface);
    }
}
