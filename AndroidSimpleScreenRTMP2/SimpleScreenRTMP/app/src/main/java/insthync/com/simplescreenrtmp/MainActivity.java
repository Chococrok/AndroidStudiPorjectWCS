...
public class MainActivity extends Activity implements View.OnClickListener, RtmpConnectionListener, ScreenRecorder.ScreenRecordListener, ScreenRecorder.SurfaceNeeded {
    ...
    private static final String DEFAULT_PUBLISH_NAME = "10211832207294405?ds=1&s_l=1&a=ATiDM_nA8tNqrACG";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        mScreenRecorder = new ScreenRecorder(width, height, bitrate, 1, audioSampleRate, audioBitrate, mediaProjection, file.getAbsolutePath(), this, this);
    ...
    @Override
    public void onSurfaceNeeded(Surface surface) {
